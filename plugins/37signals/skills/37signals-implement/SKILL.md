...
description: >-
  ...
  conventions across schema, models, controllers, Hotwire, jobs, deploy impact,
  and tests.
license: MIT
metadata:
  author: agent-skills
...
Use this skill as the primary entrypoint for end-to-end Rails work. Break a feature into the right 37signals specialist skills, sequence them in dependency order, and keep the final implementation coherent.
