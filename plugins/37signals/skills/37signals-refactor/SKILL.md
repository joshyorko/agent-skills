---
name: 37signals-refactor
description: >-
  Use when incrementally refactoring Rails code toward 37signals-inspired
  conventions without a risky rewrite.
license: MIT
metadata:
  author: agent-skills
  version: "1.0"
...
Use this skill to drive incremental Rails refactors toward 37signals-inspired patterns when the user wants that direction. Diagnose the current shape, choose a low-risk sequence, and hand each refactor step to the right specialist skill.
