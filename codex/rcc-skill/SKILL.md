...
2. Pre-build the environment after init (required): `rcc ht vars -r <dir>/robot.yaml`.
...
- Before updating any `uv` pin, check the latest release on PyPI and update all templates consistently. As of February 3, 2026, the latest `uv` is `0.9.28`.
